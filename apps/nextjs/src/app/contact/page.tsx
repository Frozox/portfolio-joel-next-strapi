  ...
  return (
    <Form {...form}>
      ...
      >
        ...
        <div
          className={cn(
            'col-span-2 my-2 w-full lg:w-64',
            formSending && 'cursor-not-allowed'
          )}
        >
          <Button type='submit' disabled={formSending} className='w-full'>
            {(formSending && (
              <>
                ...
                <span className='animate-bounce text-xl font-bold delay-75'>
                  .
                </span>
                <span className='animate-bounce text-xl font-bold delay-100'>
                  .
                </span>
              </>
            )) ||
