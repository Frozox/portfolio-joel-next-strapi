...
export interface ApiArtCategoryArtCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    art_tag_categories: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiArtTagCategoryArtTagCategory
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    art_categories: Schema.Attribute.Relation<
      'manyToMany',
      'api::art-category.art-category'
    >;
    art_tags: Schema.Attribute.Relation<'oneToMany', 'api::art-tag.art-tag'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiArtTagArtTag extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    art_tag_category: Schema.Attribute.Relation<
      'manyToOne',
      'api::art-tag-category.art-tag-category'
    >;
...
export interface ApiArtArt extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    art_category: Schema.Attribute.Relation<
      'manyToOne',
      'api::art-category.art-category'
    >;
    art_tags: Schema.Attribute.Relation<'manyToMany', 'api::art-tag.art-tag'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  ...
  attributes: {
    content: Schema.Attribute.DynamicZone<
      [
        ...
        'visual-components.spacer-component',
      ]
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface PluginUploadFile extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    thumbhash: Schema.Attribute.JSON;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
