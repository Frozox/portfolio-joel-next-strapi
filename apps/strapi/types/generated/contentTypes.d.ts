...
export interface ApiArtCategoryArtCategory extends Schema.CollectionType {
...
export interface ApiArtTagArtTag extends Schema.CollectionType {
...
export interface ApiArtArt extends Schema.CollectionType {
  ...
  attributes: {
    art_category: Attribute.Relation<
      'api::art.art',
      'manyToOne',
      'api::art-category.art-category'
    >;
